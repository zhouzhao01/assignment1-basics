...
def run_rope(
    ...
    """
    from basic_blocks.RoPE import RoPE_fast
    RoPE_layer = RoPE_fast(theta=theta, d_k=d_k,max_seq_len=max_seq_len)
    return RoPE_layer(in_query_or_key)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return custom_optimizer.get_lr_cosine_schedule(
        t=it,
